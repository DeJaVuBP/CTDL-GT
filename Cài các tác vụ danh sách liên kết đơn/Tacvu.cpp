...
public:
    ...
    // 4. Tìm kiếm phần tử theo vị trí
    ...
    // 5. Thêm phần tử vào đầu danh sách
    ...
    // 6. Thêm phần tử sau một phần tử có giá trị value
    ...
    // 7. Thêm phần tử vào danh sách theo thứ tự tăng dần
    ...
    // 9. Xóa phần tử sau một phần tử có giá trị value
    ...
    // 10. Xóa phần tử có giá trị cụ thể
    ...
    // 11. Xóa phần tử tại vị trí thứ order
    ...
    // 14. Sắp xếp danh sách tăng dần (Selection Sort)
    void selectionSort()
    {
        if (!head || !head->next)
            return;
    ...
    // 15. Lấy nội dung của một phần tử theo vị trí
...
// Hàm main để kiểm tra danh sách liên kết đơn
int main()
{
    LinkedList list;
